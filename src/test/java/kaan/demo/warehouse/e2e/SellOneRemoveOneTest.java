...
@SpringBootTest(properties = { "app.data.inventory.json.path=/test/json/test10-inventory.json",
		"app.data.product.json.path=/test/json/test10-products.json" })
@AutoConfigureMockMvc
public class SellOneRemoveOneTest extends BaseTest {
	@Autowired
	private MockMvc mvc;
	...
	@DisplayName("Sell One Product Other Product Will be Exhausted")
	@Test
