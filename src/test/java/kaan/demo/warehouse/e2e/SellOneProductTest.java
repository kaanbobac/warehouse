...
@SpringBootTest(properties = { "app.data.inventory.json.path=/test/json/test08-inventory.json",
		"app.data.product.json.path=/test/json/test08-products.json" })
@AutoConfigureMockMvc
public class SellOneProductTest extends BaseTest {
	@Autowired
	private MockMvc mvc;
	...
	@DisplayName("Sell One Product and It Will be Exhausted")
	@Test
