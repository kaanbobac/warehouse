...
@SpringBootTest(properties = { "app.data.inventory.json.path=/test/json/test07-inventory.json",
		"app.data.product.json.path=/test/json/test07-products.json" })
@AutoConfigureMockMvc
public class QueryAllProductNotValidArticle extends BaseTest {
	@Autowired
	private MockMvc mvc;
