...
@SpringBootTest(properties = { "app.data.inventory.json.path=/test/json/test05-inventory.json",
		"app.data.product.json.path=/test/json/test05-products.json" })
@AutoConfigureMockMvc
public class QueryAllProductsOnlyOneAvailableTest extends BaseTest {
	@Autowired
	private MockMvc mvc;
	...
	@DisplayName("One Product Ammount is Higher Than Stock")
	@Test
